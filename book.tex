...
(power of two version from a private training camp)
computing $\binom{n}{k} \pmod {2^{32}}$, $0 \le k \le n \le 10^{18}$
(Lucas' theorem doesn't apply to prime powers)
count powers of two
decompose into odd factorials, overlapping intervals, periodic mod m
latency
simd
auto-vectorization
