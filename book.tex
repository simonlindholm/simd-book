...
struct Mont {
	...
	Mont(u32 mod) : mod(mod), npr(-invp2(mod)) {}
...
\end{lstlisting}
1.367s. This is again slightly worse than the Barrett reduction, but as with the floating-point modmul, the potential for SIMD is higher since there are no \mbox{$64*64\rightarrow128$}-bit multiplications.
